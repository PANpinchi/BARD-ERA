...
class CocoDataset(CustomDataset):
    # CLASSES = ('background', 'fish', 'reefs', 'aquatic plants', 'wrecks/ruins','human divers', 'robots', 'sea-floor')
    # PALETTE = [(100, 80, 0), (220, 20, 60), (119, 11, 32), (0, 0, 142), (0, 0, 230), (106, 0, 228), (0, 60, 100), (0, 80, 100)]
